...
* **Multi-Factor & Social SSO:** Google Sign-In, Sign in with Apple (strict nonce validation), Biometric Auth (FaceID / Fingerprint), SMS OTP Gateways (MSG91).
* **Access Control:** Role-Based Access Control (RBAC) with dual-role state machines (e.g., Driver vs. Host), PostgreSQL Row-Level Security (RLS) enforcement.
...
* **Frameworks:** React 19, Next.js (App Router, Server Components), Vite 6, Node.js, Express.
...
* **Companion Repositories:**
  * [`park-dady-host-`](https://github.com/sangamesh5588/park-dady-host-) — Host inventory management, spot availability scheduler, and earnings analytics.
  * [`parkconnect`](https://github.com/sangamesh5588/parkconnect) — Web onboarding dashboard built with React, Vite, and Tailwind CSS.

### 2. 🎉 [SyloNow — Distributed On-Demand Services & Event Tech](https://github.com/sangamesh5588/sylonow_web_app)
...
### 4. 💼 [SalesTeam — Enterprise CRM & Pipeline State Machine](https://github.com/sangamesh5588/salesteam)
...
* **Core Engineering Feats:**
  * Normalized relational schema in PostgreSQL with automated status triggers.
  * Server-side rendering (SSR) via Next.js for sub-100ms dashboard page loads.
